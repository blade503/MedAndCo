...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIpAddress = (EditText) findViewById(R.id.ip);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            try {
                post_dict.put("username" , nickname);
            ...
            new UserLoginTask().execute(String.valueOf(post_dict),ip);
        }
    }

    private boolean isNicknameValid(String nick) {
        //TODO: a modifier au besoin
        return true;
    }
    ...
    public class UserLoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("https://"+params[1]+":8080/api/login");
        ...
        protected void onPostExecute(String success) {
            ...
            if (success != null) {
                ...
                try {
                    ...
                    JSONObject auth = obj.getJSONObject("authToken");
                ...
                async.execute(token, mIpAddress.getText().toString());
                finish();
            } else {
